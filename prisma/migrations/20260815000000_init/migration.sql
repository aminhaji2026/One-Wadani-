...
-- CreateIndex
CREATE INDEX "Office_active_idx" ON "Office"("active");

-- CreateIndex
CREATE UNIQUE INDEX "Member_membershipNo_key" ON "Member"("membershipNo");

-- CreateIndex
CREATE INDEX "Member_officeId_idx" ON "Member"("officeId");
...
-- CreateIndex
CREATE INDEX "Supporter_officeId_idx" ON "Supporter"("officeId");

-- CreateIndex
CREATE INDEX "Supporter_country_idx" ON "Supporter"("country");
...
-- CreateIndex
CREATE INDEX "Volunteer_officeId_idx" ON "Volunteer"("officeId");

-- CreateIndex
CREATE INDEX "Volunteer_status_idx" ON "Volunteer"("status");

-- CreateIndex
CREATE INDEX "FundraisingCampaign_officeId_idx" ON "FundraisingCampaign"("officeId");
...
-- CreateIndex
CREATE INDEX "Budget_officeId_year_idx" ON "Budget"("officeId", "year");

-- CreateIndex
CREATE INDEX "Expense_officeId_idx" ON "Expense"("officeId");
...
-- CreateIndex
CREATE INDEX "Event_officeId_idx" ON "Event"("officeId");
...
-- CreateIndex
CREATE INDEX "Document_confidential_idx" ON "Document"("confidential");
...
-- CreateIndex
CREATE INDEX "Meeting_officeId_idx" ON "Meeting"("officeId");

-- CreateIndex
CREATE INDEX "Meeting_startsAt_idx" ON "Meeting"("startsAt");

-- CreateIndex
CREATE INDEX "Conversation_officeId_idx" ON "Conversation"("officeId");
...
-- AddForeignKey
ALTER TABLE "Meeting" ADD CONSTRAINT "Meeting_officeId_fkey" FOREIGN KEY ("officeId") REFERENCES "Office"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_officeId_fkey" FOREIGN KEY ("officeId") REFERENCES "Office"("id") ON DELETE SET NULL ON UPDATE CASCADE;
