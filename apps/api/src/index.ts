...
app.get('/health',(_,res)=>res.json({ok:true,service:'waddani-api'}));
...
app.use('/api/auth',authRoutes); app.use('/api',crudRoutes); app.use('/api',extendedRoutes); app.use('/api',paymentRoutes); app.use('/api/analytics',analyticsRoutes);
